#!/usr/bin/env python3
"""jstack-savetobrain-from-claude transcript extractor.
...
immediately as pending raw for `/jstack-brainwork` to ingest.
...
def render_drop(
    ...
    `/jstack-brainwork` can ingest it via Standard Ingest or Personal Ingest
