...
| `/jstack-html` | A lesson or reference document needs to be rendered as a clean, on-brand standalone HTML file. |
| `/jstack-savetobrain` | A durable insight emerged that belongs in the second brain (a decision or fact about the user), not just in the teaching workspace. |
