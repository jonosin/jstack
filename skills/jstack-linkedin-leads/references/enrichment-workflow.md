...
Once enriched profiles are merged and deduped, continue with qualification batches from `references/search-qualification-workflow.md`, then hand the final `prospects.csv` to `jstack-linkedin-send` for validation and sending.
