...
```bash
python3 ~/jstack/skills/init/scripts/docs_index.py index --write --repo <workspace>
python3 ~/jstack/skills/init/scripts/docs_index.py lint --repo <workspace>
```
...
Do not run `/savetobrain` merely because this artifact exists. It would duplicate the canonical
