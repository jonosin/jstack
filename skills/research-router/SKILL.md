...
| Next | When |
|------|------|
| `/last30days` | Jono wants current social/forum sentiment across Reddit, X, YouTube, TikTok, HN, GitHub, or Polymarket rather than a general research pass. |
| `/savetobrain` | Jono explicitly asks to save/capture the research result into the second brain. |
| `/brainwork` | Saved raw research should be compiled into wiki canon. |
