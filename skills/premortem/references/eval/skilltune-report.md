# premortem — skilltune report (2026-06-24)

**Target:** improve the **failure-mode generation quality + output discipline** of `premortem`, a
...
- Canonical `~/jstack/skills/premortem/SKILL.md` was backed up, then `v1` was copied over it.
