...
bash "$HOME/jstack/skills/jstack/scripts/skill-lint.sh" "$skill_dir"
"$python" "$HOME/jstack/skills/jstack-init/scripts/docs_index.py" lint --repo "$repo" --satellite-kind build
...
for path in (
    repo / ".agents/skills/jstack-fopus-tileforge",
    repo / ".claude/skills/jstack-fopus-tileforge",
    Path.home() / ".codex/skills/jstack-fopus-tileforge",
    Path.home() / ".hermes/skills/jstack/jstack-fopus-tileforge",
):
