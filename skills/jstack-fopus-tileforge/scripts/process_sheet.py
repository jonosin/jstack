...
def process(contract_path: Path, sources: dict[str, Path], output_dir: Path, *, tolerance: int) -> dict:
...
def main() -> None:
    ...
    parser.add_argument("--palette", type=int, default=64, help="Reserved for package palette validation.")
    args = parser.parse_args()
    process(args.contract, _sources(args.source), args.outdir, tolerance=args.tolerance)
